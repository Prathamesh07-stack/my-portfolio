        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>RAG Pipelines & Agentic AI</h4>
              <p>
                Building intelligent LLM-powered systems and autonomous AI
                agents that automate complex workflows and deliver context-aware
                responses at scale.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>DeFi, Smart Contracts & dApps</h4>
              <p>
                Integrating blockchain infrastructure into production apps—smart
                contracts, DeFi staking pools, on-chain wallets, and crypto
